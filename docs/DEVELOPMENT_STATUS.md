...
> 当前分支为 `main`。PR #16 已普通 merge，merge commit 为 `588db6ee5b2a6c466c618249f072591af47609a1`。Flyway 保持 V1–V7（23 张业务表）；PR #16 未新增迁移、未写正式 `rike_tiku`、未修改 MVP30 原始 Excel。

更新时间：2026-08-07

## 当前主线状态

- 当前分支：`main`；PR #16 已普通 merge，merge commit 为 `588db6ee5b2a6c466c618249f072591af47609a1`。
