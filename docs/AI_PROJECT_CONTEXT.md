...
> 当前工作分支为 `main`。PR #20 已普通 merge，merge commit 与合并业务基线 main HEAD 为 `1055dee567b7afa153750792670fb0bafed1151c`；Flyway V1–V9、26 张业务表，V1–V8 与 MVP30 原始 Excel 未修改。
...
- 状态：题库、账号、教学组织、学生练习闭环、教师班级学科工作台、高频考点和师生私信均已进入 `main`。
- 当前分支：`main`；PR #20 已普通 merge，远程功能分支已删除。
...
学生导入、管理员单学生管理、教师管理、三元任课关系、题库审核发布、MVP30 导入、学生练习闭环、UI、统一认证、学生三科工作台、教师班级学科工作台、高频考点和私信均已进入 `main`。Demo90 不等于 MVP30 正式真实题库。基础个人资料、掌握度、推荐和 AI 能力仍未实现。
