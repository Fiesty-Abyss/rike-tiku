...
- 状态：题库、账号、教学组织、学生练习闭环、教师班级学科工作台、高频考点和师生私信均已进入 `main`；PR #21 当前分支新增非 AI 的掌握度与规则推荐。
...
学生导入、管理员单学生管理、教师管理、三元任课关系、题库审核发布、MVP30 导入、学生练习闭环、UI、统一认证、学生三科工作台、教师班级学科工作台、高频考点和私信均已进入 `main`。PR #21 当前分支已实现规则掌握度和推荐。Demo90 不等于 MVP30 正式真实题库；基础个人资料和 AI 能力仍未实现。
