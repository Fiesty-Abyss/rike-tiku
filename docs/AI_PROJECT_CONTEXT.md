...
> 当前工作分支为 `main`。PR #16 已普通 merge，merge commit 为 `588db6ee5b2a6c466c618249f072591af47609a1`。独立 `rike_tiku_demo` 的原创 Demo90 已进入 `main`；Flyway 保持 V1–V7（23 张业务表），PR #16 无迁移、未写正式 `rike_tiku`、未修改 MVP30 原始 Excel。
