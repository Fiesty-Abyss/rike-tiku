...
| MA-026 | PUBLIC/AUTH/STUDENT/TEACHER/ADMIN | 全站视觉系统与动态叙事 | 查看 Portal 六场景、登录/角色入口、三科学生与教师环境、管理员工作台，并体验桌面滚动与 390px 降级 | 第一眼具有水、空气、透明光学和自然科技共生的 Frutiger Aero；三科科学语义清楚；至少一个连续 scroll-driven 与合理 pinned scene；工作区仍清楚高效 | Round 3 视觉人工验收失败后，Round 4 以 `RIKE Aqua Future` 重建设计 token、材质、排版、共享 shell、Portal/Auth 与三角色工作台；四张原创 Aqua WebP、Physics pin+scrub、学科环境转场、pointer 光学反馈、移动端与 reduced-motion 降级均已进入当前分支，MA-022 至 MA-025 业务能力未回退 | UX | Round 4 前端门禁为 50/50 文件、174/174 测试，type-check/build PASS、audit 0；build 如实保留 main chunk 797.43 kB（gzip 254.25 kB）警告。机器截图与 motion 说明位于 `docs/evidence/pr27-ui-round4/`，不能替代用户视觉复验 | `FIXED_AWAITING_USER_RETEST` |
