...
| TEACHER/STUDENT | 专题主观大题混合组卷、发布与历史管理 | `/teacher/papers`、`/teacher/papers/:id/:version`、`/student/papers/:releaseId` | `TeacherPaperBuilderView.vue`、`PaperPreviewView.vue`、`StudentPapersView.vue` | `api/teacher/papers.ts`、`api/student/papers.ts` | `shijuan/PaperController`、`PaperAssignmentTeacherController`、`PaperAssignmentStudentController` | `PaperService`、`PaperAssignmentService` | `ti_mu`、`shi_juan`、`shi_juan_ti_mu`、`shi_juan_fa_bu`、`shi_juan_fa_bu_ti_mu`、`shi_juan_ti_jiao`、`shi_juan_xue_sheng_da_ti` | 中文题型映射、V30 附件快照、客观确定性判分、`SUBJECTIVE_PENDING`、release 撤回、软删除本体与历史保留 | `PaperAssignmentIntegrationTest`,`TeacherPaperBuilderView.spec.ts`,`PaperPreviewView.spec.ts`,`StudentPapersView.spec.ts` |
...
| STUDENT | AI 对话 | 当前题 Drawer | `StudentAiLearningPanel.vue` | `api/student/aiLearning.ts` | `StudentAiController` | `StudentAiService` | `ai_hui_hua`,`ai_xiao_xi` | 当前题绑定、最多 10 轮、身份/注入 guard | `StudentAiServiceIntegrationTest`,`StudentAiLearningPanel.spec.ts` |
