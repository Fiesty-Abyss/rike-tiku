...
| 2026-08-18，PR #35 | `fix/paper-release-management` | 任课范围唯一选择、私有题隔离、班级发布记录、学生提交查看、撤回、试卷软删除与历史保留 | 待 ordinary merge；最终自动化为后端 221（0/0/3）、前端 68 files / 224 tests（0 failures）；用户已人工接受，未声明本轮机器浏览器复跑。 |
