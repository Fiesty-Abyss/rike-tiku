...
export interface PracticeQuestion { practiceQuestionId:number; order:number; questionType:QuestionType; stem:string; difficulty:number; score:number; blankCount:number; options:Option[]; knowledgePoints:KnowledgePoint[]; attachments:Attachment[] }
