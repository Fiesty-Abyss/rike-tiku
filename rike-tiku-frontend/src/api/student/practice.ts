...
export interface WrongQuestionFilters { subjectCode?:string; knowledgePointId?:number; status?:WrongQuestionFilterStatus; keyword?:string; page?:number; size?:number }
