...
> PR #27 最终机器门禁已通过：后端 117 个测试 0 失败、1 个符号链接 assumption skipped，package PASS；前端 129/129、type-check、build PASS，audit 0；Demo reset/seed/validate/smoke PASS，120 道业务题分布为物理 40、化学 39、生物 41。人工 CAPTCHA/浏览器视觉验收仍统一延期，未执行结果不写为人工 PASS。
