...
CREATE TABLE `ai_hui_hua` (
  ...
  CONSTRAINT `ck_ai_hui_hua_context` CHECK ((((`shang_xia_wen_lei_xing` = _utf8mb4'PRACTICE_RESULT') and (`xue_sheng_da_ti_id` is not null) and (`lian_xi_ti_mu_id` is not null) and (`zhuan_ti_ti_mu_id` is null)) or ((`shang_xia_wen_lei_xing` = _utf8mb4'TOPIC_QUESTION') and (`xue_sheng_da_ti_id` is null) and (`lian_xi_ti_mu_id` is null) and (`zhuan_ti_ti_mu_id` is not null)))),
...
CREATE TABLE `gao_pin_kao_dian` (
  ...
  CONSTRAINT `ck_gao_pin_kao_dian_type` CHECK ((`zi_liao_lei_xing` in (_utf8mb4'POINT',_utf8mb4'FORMULA',_utf8mb4'CHEMICAL_EQUATION',_utf8mb4'MNEMONIC',_utf8mb4'TABLE',_utf8mb4'NOTE')))
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='教师维护的班级学科高频考点';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='题目附件引用';
/*!40101 SET character_set_client = @saved_cs_client */;
