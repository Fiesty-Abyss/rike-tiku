...
$required = @(
    ...
    "docs/evidence/thesis-final/25-password-recovery-desktop.png",
    "docs/evidence/thesis-final/26-password-recovery-mobile.png",
    "docs/evidence/thesis-final/27-wrong-question-review.png",
    "docs/evidence/thesis-final/28-topic-units.png",
    "docs/evidence/thesis-final/29-student-papers.png",
    "docs/evidence/thesis-final/30-knowledge-cards.png",
    "docs/evidence/thesis-final/31-message-actions.png",
    "docs/evidence/thesis-final/32-private-question-bank.png",
    "docs/evidence/thesis-final/33-teacher-knowledge-cards.png",
    "docs/evidence/thesis-final/34-paper-publish-quality.png",
    "docs/evidence/thesis-final/35-operation-log-search.png",
    "docs/evidence/thesis-final/36-question-import.png",
    "docs/evidence/thesis-final/37-student-import.png",
    "docs/evidence/thesis-final/38-vision-provider-config.png",
    "docs/evidence/thesis-final/39-question-review.png",
    "docs/evidence/thesis-final/40-message-menu.png",
    "docs/evidence/thesis-final/41-message-recall-confirm.png",
    "docs/evidence/thesis-final/42-message-delete-confirm.png",
    ...
    "database/schema_snapshot_v29.sql",
