...
public class JiaoShiGuanLiController {
    ...
    @PutMapping("/teachers/{id}") public JiaoShiXiangYing update(@PathVariable Long id,@Valid @RequestBody JiaoShiXiuGaiQingQiu request,@AuthenticationPrincipal RenZhengYongHu user){return service.update(id,request,user.id());}
